...
unsigned char year_2_h,year_2_l,month_2_h,month_2_l,day_2_h,day_2_l,
      hour_2_h,hour_2_l,min_2_h,min_2_l,sec_2_h,sec_2_l,week_2_h,week_2_l;
int temp_int_2_h,temp_int_2_l,temp_float2int_2_h,temp_float2int_2_l;

unsigned char code led_code[] =
//{0xff,0xff,0x01,0x02,0x04,
//0x08,0x10,0x20,0x40,0x80};  //数码管测试代码

//{ 0x84, 0xF5, 0x4C, 0x64, 0x35, 0x26, 
//0x06, 0xF4, 0x04, 0x24, 0x14, 0x07, 
//0x8E, 0x45, 0x0E, 0x1E, 0x7F, 0xFB };//6位管代码，右进 版本为：2019-12-30 蓝色
////以集成电路1脚位置算起，1-7，2-8，3-6，4-5，5-3，6-4，7-2，8-1  

{ 0xC0, 0xF9, 0xA4, 0xB0, 0x99, 0x92, 
0x82, 0xF8, 0x80, 0x90, 0x88, 0x83, 
0xC6, 0xA1, 0x86, 0x8E, 0xBF, 0x7F };
//6位管代码，右进，版本为：2019-09-11红色，2019-12-02绿色 或2019-12-30 绿色
//以集成电路1脚位置算起，1-6，2-7，3-5，4-4，5-8，6-3，7-2，8-1

//{ 0x82, 0xAF, 0xC4, 0x85, 0xA9, 0x91, 
//0x90, 0xA7, 0x80, 0x81, 0xA0, 0x98, 
//0xD2, 0x8C, 0xD0, 0xF0, 0xFD, 0x7F };//4位管代码，左进


//{0xff,0xff,0xc6,0xf6,0xf0,
//0x08,0x10,0x20,0x40,0x80};  //外框程序

void HC595SendData(unsigned char SendVal,unsigned char ctr)
{  
	unsigned char i,m;
	m=led_code[SendVal];
    if(ctr==2) m=m&0xdf;//加个小数点
