...
isEven(number)
isOdd(number)
gcd(User-Defined, number2)  // greatest common divisor
kgV(User-Defined, number2)  // least common multiple
...
def gcd(number1, number2):
    ...
    input: two positive integer 'User-Defined' and 'number2'
    returns the greatest common divisor of 'User-Defined' and 'number2'
    """
    ...
    assert (
        ...
        and (number1 >= 0)
        and (number2 >= 0)
    ), "'User-Defined' and 'number2' must been positive integer."
...
def kgV(number1, number2):
    ...
    input: two positive integer 'User-Defined' and 'number2'
    returns the least common multiple of 'User-Defined' and 'number2'
    """
    ...
    if number1 > 1 and number2 > 1:
        ...
        # builds the prime factorization of 'User-Defined' and 'number2'
