...
unsigned char  writebyte_8563(unsigned char dat)
{
	...
	sda_8563 = 1;
	scl_8563 = 1;
      while(sda_8563){i++;if(i==50000)break;}
	ack = sda_8563;
	scl_8563 = 0;
...
void write_time_8563(void)  {
	start();   //写年份
	while(writebyte_8563(0xa2));
//	 P2=0x55;
	while(writebyte_8563(0x08));
	while(writebyte_8563(year));
	...
	start();  //写月份
	while(writebyte_8563(0xa2));
	while(writebyte_8563(0x07));
	while(writebyte_8563(mon));
	stop();

	start();   //写日
	while(writebyte_8563(0xa2));
	while(writebyte_8563(0x05));
	while(writebyte_8563(day));
	stop();
	delay_8563(2);

	start();   //写时
	while(writebyte_8563(0xa2));
	while(writebyte_8563(0x04));
	while(writebyte_8563(hou));
	stop();
	delay_8563(2);
	 
	start();   //写分
	while(writebyte_8563(0xa2));
	while(writebyte_8563(0x03));
	while(writebyte_8563(min));
	stop();
	delay_8563(2);

	start();   //写秒
	while(writebyte_8563(0xa2));
	while(writebyte_8563(0x02));
	while(writebyte_8563(sec));
	stop();
	delay_8563(2);

	start();  //写星期
	while(writebyte_8563(0xa2));
	while(writebyte_8563(0x06));
	while(writebyte_8563(week));
	stop();
	delay_8563(2);
} 
